...
export interface AppKeybindings {
	...
	"app.exit": true;
	"app.suspend": true;
	"app.editMode.cycle": true;
	"app.model.cycleForward": true;
	"app.model.cycleBackward": true;
	"app.model.select": true;
	"app.tools.expand": true;
	"app.tools.expandSingle": true;
...
declare module "@earendil-works/rozsa-tui" {
...
export const KEYBINDINGS = {
	...
	"app.tools.expandSingle": { defaultKeys: "alt+o", description: "Toggle last tool output" },
	"app.thinking.toggle": {
		defaultKeys: "ctrl+t",
	...
	"app.subagent.next": {
		defaultKeys: "ctrl+]",
		description: "Switch to next subagent view",
	},
	"app.subagent.previous": {
		defaultKeys: "ctrl+[",
		description: "Switch to previous subagent view",
	},
	"app.session.new": { defaultKeys: [], description: "Start a new session" },
	"app.session.tree": { defaultKeys: [], description: "Open session tree" },
	"app.session.graph": { defaultKeys: [], description: "Open session graph panel" },
...
const KEYBINDING_NAME_MIGRATIONS = {
	...
	exit: "app.exit",
	suspend: "app.suspend",
	cycleThinkingLevel: "app.editMode.cycle",
	...
	nextSubagent: "app.subagent.next",
	previousSubagent: "app.subagent.previous",
