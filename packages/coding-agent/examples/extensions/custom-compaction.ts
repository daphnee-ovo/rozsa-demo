 ...
 *
 * Usage:
 *   rozsa --extension examples/extensions/custom-compaction.ts
 */

import { complete } from "@earendil-works/rozsa-ai";
import type { ExtensionAPI } from "@earendil-works/rozsa-coding-agent";
import { convertToLlm, serializeConversation } from "@earendil-works/rozsa-coding-agent";

export default function (rozsa: ExtensionAPI) {
	rozsa.on("session_before_compact", async (event, ctx) => {
