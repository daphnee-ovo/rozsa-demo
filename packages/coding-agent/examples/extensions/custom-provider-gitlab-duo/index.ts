 ...
 * Delegates to rozsa-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   rozsa -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (rozsa: ExtensionAPI) {
	rozsa.registerProvider("gitlab-duo", {
