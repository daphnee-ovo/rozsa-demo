import { complete, getModel } from "@earendil-works/rozsa-ai";
import type { ExtensionAPI, ExtensionCommandContext } from "@earendil-works/rozsa-coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@earendil-works/rozsa-coding-agent";
import { Container, Markdown, matchesKey, Text } from "@earendil-works/rozsa-tui";
...
export default function (rozsa: ExtensionAPI) {
	rozsa.registerCommand("summarize", {
