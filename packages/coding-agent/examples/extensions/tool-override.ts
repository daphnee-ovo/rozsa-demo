 ...
 * - Routing tool calls to remote systems (e.g., rozsa-ssh-remote)
 ...
 *
 * Usage:
 *   rozsa -e ./tool-override.ts
 */

import type { TextContent } from "@earendil-works/rozsa-ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@earendil-works/rozsa-coding-agent";
...
export default function (rozsa: ExtensionAPI) {
	...
	rozsa.registerCommand("read-log", {
