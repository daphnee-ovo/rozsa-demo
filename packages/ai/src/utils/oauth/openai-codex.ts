...
const CALLBACK_HOST = process.env.ROZSA_OAUTH_CALLBACK_HOST || "127.0.0.1";
 ...
 * @param options.originator - OAuth originator parameter (defaults to "rozsa")
 */
