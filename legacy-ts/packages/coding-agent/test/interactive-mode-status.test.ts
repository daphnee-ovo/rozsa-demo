		...
		return [
			...
			},
			{
				...
				sourceInfo: createSourceInfo(
					"/tmp/project/.rozsa/npm/node_modules/rozsa-markdown-preview/extensions/index.ts",
					{
			...
			},
			{
				...
				sourceInfo: createSourceInfo(
					"/tmp/project/.rozsa/npm/node_modules/@scope/rozsa-scoped/extensions/index.ts",
					{
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		...
		const fakeThis = createShowLoadedResourcesThis({
			...
			cwd,
			contextFiles: [
				{ path: path.join(home, ".rozsa", "agent", "AGENTS.md") },
