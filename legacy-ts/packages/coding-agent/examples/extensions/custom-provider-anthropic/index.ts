 ...
 *   rozsa -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... rozsa -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (rozsa: ExtensionAPI) {
	rozsa.registerProvider("custom-anthropic", {
