 ...
 * working indicator shown while rozsa is streaming a response.
 *
 * Usage:
 *   rozsa --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore rozsa's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@earendil-works/rozsa-coding-agent";
...
export default function (rozsa: ExtensionAPI) {
	...
	rozsa.registerCommand("working-indicator", {
