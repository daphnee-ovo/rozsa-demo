 ...
 *
 * Usage: rozsa --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@earendil-works/rozsa-tui";

export default function (rozsa: ExtensionAPI) {
	rozsa.registerCommand("overlay-test", {
