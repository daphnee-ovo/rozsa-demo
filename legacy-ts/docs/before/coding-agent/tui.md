...
**Source:** [`@earendil-works/rozsa-tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@earendil-works/rozsa-tui";
...
```typescript
import { Container, type Focusable, Input } from "@earendil-works/rozsa-tui";
...
Import from `@earendil-works/rozsa-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@earendil-works/rozsa-tui";
```
...
```typescript
import { matchesKey, Key } from "@earendil-works/rozsa-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@earendil-works/rozsa-tui";
...
```typescript
import { getMarkdownTheme } from "@earendil-works/rozsa-coding-agent";
import { Markdown } from "@earendil-works/rozsa-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@earendil-works/rozsa-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@earendil-works/rozsa-coding-agent";
import { DynamicBorder } from "@earendil-works/rozsa-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@earendil-works/rozsa-tui";
...
```typescript
import { BorderedLoader } from "@earendil-works/rozsa-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@earendil-works/rozsa-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@earendil-works/rozsa-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@earendil-works/rozsa-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@earendil-works/rozsa-coding-agent";
import { matchesKey, truncateToWidth } from "@earendil-works/rozsa-tui";
