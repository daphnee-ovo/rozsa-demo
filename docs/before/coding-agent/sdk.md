...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@earendil-works/rozsa-coding-agent";
...
```bash
npm install @earendil-works/rozsa-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@earendil-works/rozsa-coding-agent";
...
The `Agent` class (from `@earendil-works/rozsa-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { createAgentSession } from "@earendil-works/rozsa-coding-agent";
...
import { createAgentSession, defineTool } from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@earendil-works/rozsa-coding-agent";
