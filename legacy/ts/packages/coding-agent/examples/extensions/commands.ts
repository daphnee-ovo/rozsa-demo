 ...
 * Commands Extension
 *
 * Demonstrates the rozsa.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@earendil-works/rozsa-coding-agent";

export default function commandsExtension(rozsa: ExtensionAPI) {
	rozsa.registerCommand("commands", {
		...
		handler: async (args, ctx) => {
			const commands = rozsa.getCommands();
