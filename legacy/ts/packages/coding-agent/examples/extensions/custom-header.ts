 ...
 * (logo + keybinding hints) with a custom component showing the rozsa mascot.
 */

import type { ExtensionAPI, Theme } from "@earendil-works/rozsa-coding-agent";
import { VERSION } from "@earendil-works/rozsa-coding-agent";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the rozsa agent character
...
export default function (rozsa: ExtensionAPI) {
	...
	rozsa.registerCommand("builtin-header", {
