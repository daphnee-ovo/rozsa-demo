...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@earendil-works/rozsa-coding-agent"><img alt="npm" src="https://img.shields.io/npm/v/@earendil-works/rozsa-coding-agent?style=flat-square" /></a>
</p>
<p align="center">
...
```bash
npm install -g --ignore-scripts @earendil-works/rozsa-coding-agent
```
...
- [@earendil-works/rozsa-ai](https://www.npmjs.com/package/@earendil-works/rozsa-ai): Core LLM toolkit
- [@earendil-works/rozsa-agent-core](https://www.npmjs.com/package/@earendil-works/rozsa-agent-core): Agent framework
- [@earendil-works/rozsa-tui](https://www.npmjs.com/package/@earendil-works/rozsa-tui): Terminal UI components
