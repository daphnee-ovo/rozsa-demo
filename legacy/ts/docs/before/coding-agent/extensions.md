...
| Package | Purpose |
|---------|---------|
| `@earendil-works/rozsa-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@earendil-works/rozsa-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@earendil-works/rozsa-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { isBashToolResult } from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { SessionManager } from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { Type } from "typebox";
import { StringEnum } from "@earendil-works/rozsa-ai";
...
```typescript
import type { AutocompleteItem } from "@earendil-works/rozsa-tui";
...
```typescript
import { withFileMutationQueue } from "@earendil-works/rozsa-coding-agent";
...
**Important:** Use `StringEnum` from `@earendil-works/rozsa-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@earendil-works/rozsa-coding-agent";
...
} from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { keyHint } from "@earendil-works/rozsa-coding-agent";
...
```typescript
import { Text, Component } from "@earendil-works/rozsa-tui";
...
import { matchesKey } from "@earendil-works/rozsa-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@earendil-works/rozsa-coding-agent";
