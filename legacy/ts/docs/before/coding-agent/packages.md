...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@earendil-works/rozsa-ai`, `@earendil-works/rozsa-agent-core`, `@earendil-works/rozsa-coding-agent`, `@earendil-works/rozsa-tui`, `typebox`.
