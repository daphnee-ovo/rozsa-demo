...
const allowValue = process.env.ROZSA_ALLOW_LOCKFILE_CHANGE;
...
if (allowed) {
	console.error("package-lock.json is staged; ROZSA_ALLOW_LOCKFILE_CHANGE is set, allowing commit.");
	process.exit(0);
}
...
console.error("  ROZSA_ALLOW_LOCKFILE_CHANGE=1 git commit ...");
process.exit(1);
